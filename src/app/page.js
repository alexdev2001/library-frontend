          ...
          <form className="items-center">
            <div className="pl-20">
              <label
                  ...
                  strokeWidth="1.5"
                  stroke="currentColor" className="w-6 h-8 text-center">
              ...
              <div className="items-center">
                <label
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        strokeWidth="1.5"
                        stroke="currentColor" className="w-6 h-8">
                        <path strokeLinecap="round" strokeLinejoin="round"
              ...
              <button  type="submit" onClick={handleLogin} className="btn btn-primary w-full text-black border-solid border-red-400 p-3">
                Sign In
              </button>
              <p>
                  <a href="" className="text-primary text-black p-4 text-sm">
                      forgot password?
                  </a>
              </p>
